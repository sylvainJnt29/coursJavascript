...
let nombreAleatoire = function getRandomInt(max) {
...
function verifier(nombre){
  ...
  // Ajouter l'element davant les autres.
...
formulaire.addEventListener('submit', (e) => {
  e.preventDefault(); // On annule l'evenement par defaut du navigateur sur l'element submit
