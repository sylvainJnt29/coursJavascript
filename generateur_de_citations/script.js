...
let citations = [
  ["Ça, c'est d'la part de Mathilda ...", "Léon"],
...
bouton.addEventListener('click', () => {
  // citation.innerText = citations[nombreAleatoire(21)][0];
  // auteur.innerText = citations[nombreAleatoire(21)][1];
  
  do {
    nombreAleatoire = getRandomInt(citations.length);
...
bouton.addEventListener("click", () => {
      ...
      let random = Math.floor(Math.random() * Math.floor(citations.length+ 1));
